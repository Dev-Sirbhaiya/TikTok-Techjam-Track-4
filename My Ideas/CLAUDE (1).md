...
| `docs/07_IDEAS_AND_REFERENCES.md` | Every idea ever raised (not just what was kept) + full research bibliography with verification status |
| `docs/08_ADVANCED_PHASES.md` | Step-by-step plan for the "world-model-lite" extension stack — Phases 2.5, 3.5, and 4, all ablation-gated |
